...
const ROOT = path.join(__dirname, '..'), EXEC = '/opt/pw-browsers/chromium-1194/chrome-linux/chrome', PORT = 8181;
...
(async () => {
  ...
  await pg.evaluate(() => {
    ...
    E.game.fuel = 85; E.game.carry = 4; E.game.banner = null;
    E.survivor.x = E.cfg.fireX - 70; E.survivor.y = E.cfg.fireY - 40; E.survivor.face = 0.5;
    for (let i = 0; i < 6; i++) { E.game.fuel = 85; E.game.carry = 4; E.step(1 / 30); }
    E.game.banner = null;
  });
  await pg.waitForTimeout(150);
  await pg.screenshot({ path: path.join(ROOT, 'scripts/shots/90-packavatar.png') });
  await b.close();
