...
const ROOT=path.join(__dirname,'..'),EXEC='/opt/pw-browsers/chromium-1194/chrome-linux/chrome',PORT=8184;
...
await pg.evaluate(()=>{const E=window.__EMBER;E.game.fuel=80;E.game.banner=null;E.game.carry=6; // pack full
  ...
  E.survivor.x=best.x-6;E.survivor.y=best.y+22;E.survivor.face=-1.3;for(let i=0;i<4;i++)E.step(1/30);E.game.banner=null;});
await pg.waitForTimeout(200);await pg.screenshot({path:path.join(ROOT,'scripts/shots/60-packfull.png')});
