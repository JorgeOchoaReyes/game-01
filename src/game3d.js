...
var UI = (function () {
  ...
  function showTitle() {
    ...
    var how = el('p', 'hint', 'Drag anywhere to move (or WASD / arrows). Chop pines for wood; return to the fire to bank it, then FEED it or buy upgrades. Swing your torch at shades to beat them back. Grab glowing drops for powers. Survive 5 nights.');
...
window.__EMBER = {
  ...
  cfg: CFG, upgrades: UPGRADES, buffs: BUFFS, feed: feedFire, buy: buyUpgrade, start: startGame, pick: pickBoon,
