...
scene.add(ambient);
var fireLight = new THREE.PointLight(0xff8a3a, 6, 40, 1.5);   // lower decay + longer reach so a healthy fire lights the whole frame
...
// inferno/swift/harvest common; sling/telekinesis/ward/nova mid; chainsaw/toolbelt rare
var DROP_POOL = ['inferno', 'swift', 'ward', 'harvest', 'inferno', 'swift', 'harvest', 'sling', 'sling', 'telekinesis', 'telekinesis', 'nova', 'chainsaw', 'toolbelt'];
...
function startGame() {
  ...
  game.combo = 0; game.comboT = 0; game.comboBest = 0; game.bonus = 0; game.endless = false; game.slingCd = 0; game.biteFloatCd = 0; game.blueFire = 0; game.tkCd = 0;
...
function renderScene(dt) {
  ...
  fireLight.intensity = (0.5 + it * 8.5) * flick * (1 + blue * 0.3);
  fireLight.distance = 8.0 + it * 24;                         // reaches the top of the frame at a healthy fuel level
  ...
  ambient.intensity = 0.3 + it * 0.4;
  moonLight.intensity = 0.4 + it * 0.2;
